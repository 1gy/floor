  ...
  },
  {
    ...
    musics: [
      ...
      },
      {
        ...
        comment:
          "あさりと申します。\nSDVX IIIにて「saminun」名義で採用いただいて以来再びの栄誉を賜りました。本当にありがとうございます！\n東方永夜抄は東方Project作品の中でも最初に体験したゲームで、当時の思い出も合わさり特に印象に残っています。\n今回のコンテストではタイトル曲「永夜抄」を2stepライクにアレンジさせていただきました。\nもとの神秘的な雰囲気に対し、活動的かつ妖しさをもった曲になっています。\n筐体のデバイスを懸け橋として、この曲を楽しんでいただけたら幸いです。\nどうぞよろしくお願いします！\n(あさり)",
      },
      {
        ...
        comment:
          "古屋直雪と申します。名前だけでも覚えていってください。\nまたこうしてSOUND VOLTEXに楽曲を採用いただけて大変光栄です。\n今回は「狂気の瞳 ～ Invisible Full Moon」をリミックス致しました。\n原曲のメロディがかっこいいので、やりがいのあるリミックスとなりました。\n是非ともお楽しみください。ありがとうございました。\n(古屋直雪)",
      },
      {
        artist: "激戦の人(第4回目配信楽曲）",
        ...
        comment:
          "この度は採用頂き、ありがとうございます。\n【東方激戦アレンジ】を製作しております、激戦の人と申します。\n既にSDVXにて【人形裁判 -THIRD IMPACT-】が配信されておりますが、\n前回とはガラッと変わったジャンルの楽曲にてお送り致します。\nぜひ、楽しんでプレイして頂ければ幸甚です。\n…(=ω=\n！(=ω=\nｄ(=ω=\n(激戦の人)",
      },
      {
        artist: "すのうまん(第4回目配信楽曲）",
        ...
        comment:
          "そして私は・・・“すのうまん”です。\n初めまして、皆々様、宜しくお願い致します。\nこの度は・・・Victim of Nightsが採用され嬉しく思ひます。とても。\n僕らしく、俺らしくなるよう注意を重ねながら曲を練り上げました。(ﾈﾘ…)\nまんすのっぽさを僅かでも感じていただけたなら、これ以上の喜び（讃うべし）はございません。\n私の珠玉のヴィクティムをでぃっぷりとご堪能下さいませ。\n(すのうまん)",
      },
      {
        ...
        comment:
          "いつも大変お世話になっております、モリモリあつしです。\nこの度は東方永夜抄リミックス楽曲コンテストに採用いただき、誠にありがとうございます。\n自分で制作した東方アレンジ楽曲で音楽ゲームがやりたくて音楽を始めた身としては今回の採用は恐悦至極に存じます。\n私自身が(MRM REMIX)という曲名を使うようになってもう長くなるのですが、\nもともとこの曲名は「SOUND VOLTEX II -infinite infection-制作決定記念 リミックスコンテスト」に楽曲を応募した際に、収録されることを前提として、いかにわかりやすく、伝わりやすいかを考え付けた曲名でした。\n読み方は「モリモリミックス」と読みます。\n当時は落選となってしまいましたが、こうして念願叶って(MRM REMIX)という曲名をSDVXで使用でき、大変うれしく思います。\nちなみに、東方アレンジをする際に○○Remixといった曲名を使うことは界隈的には珍しいのですが、\n今回は音楽ゲーム向けの東方アレンジということで、この曲名を付けさせていただきました。\n作曲に限らず、何か新しいことに挑戦しようと思った時は、とにかく不格好でも良いから「やってみる」ことが本当に大事ですね。\n年齢を重ねるにつれ、何かに挑戦することが億劫になってしまったり、自分に出来ることだけをしようと小さくまとまってしまいがちですが、\nいつまでも変化し続けてこそ、人間って前に進むものなんじゃないかな、とこのリミックスを制作して思いました。\n(モリモリあつし)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：ZYANNA\n採用ありがとうございます！ZYANNAです。\nかっこよさ全開のハイテックな慧音を描かせていただきました！\nモリモリあつしさんの楽曲で初のジャケット採用をいただけるなんてホントに夢のようです…！\nボルテで偶然マッチングしたのがモリモリあつしさんと知り合ったきっかけであり、まさかこのような形で一緒に作品を作る機会をいただけるなんて思ってもいませんでした。\nモリモリあつしさんのかっこいい曲を表現できるようめちゃくちゃ試行錯誤して描いたので、是非この曲とイラストを楽しみながらプレイしていただけたら嬉しいです！\n(ZYANNA)",
      },
      {
        ...
        comment:
          "採用頂きありがとうございます。梅干茶漬けです。ダイエット始めました。\nジャケットをお願いしたねふさんに「どのキャラ描きたい？」と聞く所から始まった今回の作品は、\n「幻視の夜　～ Ghostly Eyes」をメインに「蠢々秋月　～ Mooned Insect」を思わせるようなフレーズを入れたり入れなかったりした楽曲となりました。\nもういっそ全く別の曲を作るぞ！くらいの勢いでしたが、いかがでしょうか？\nスッと入って頭に残るメロディが特徴の、それこそ何度もアレンジされただろうこの曲で、\n少しでも茶漬けっぽさ（not食品名）を感じていただければ幸いです。\n以上、梅干茶漬けでした。梅干し茶漬けじゃないよ！\n(梅干茶漬け)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：ねふ\n採用頂きありがとうございます。鮭茶漬け派のねふです。にゃーん。\n今回は憧れの梅干茶漬けさんからジャケット作成のお誘いをいただき、\nとても緊張しながら描いたのを覚えています。\nタイトルのフォントの作成や配置など慣れないことばかりで大変でしたが\n精一杯曲のイメージに沿えるよう頑張りましたので\nぜひプレイしていただけると幸いです。にゃーん。\n(ねふ)",
      },
      {
        ...
        comment:
          "ボーカル担当しました！okogeeechann(おこげちゃん)です！\n自分の声が流れてくると思うだけで興奮極まりないです！！\nNAMASUTEって感じです！！\nぜひぜひ！テンションアゲアゲでゲームを楽しんでいただければと思います！！\n(okogeeechann)\nハロー！東方アレンジサークル『Adust Rain』の kissssy だよ！\n今回のアレンジでは作詞を担当したよ！\nみんな！！！SOUND VOLTEXでこの曲をプレイするんだ！！\n(kissssy)\nどうもはじめましてRemixでの編曲を担当しましたMenikichiです。\n名前だけでも覚えて帰っていただければなと思っております。\n僕自身プレーするのがとても楽しみです。皆さんも是非プレーしてみてください！\n(Menikichi)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：mirimo\n商業同人問わずイラストやデザインで活動しているmirimoと申します。\n今回大好きな作品である東方projectで採用いただき大変嬉しく思います。\n好きな楽曲のひとつがゲームで楽しめるということでわくわくしてます！\n配信されたらぜひ遊んでいただけると嬉しいです。\n(mirimo)",
      },
      {
        artist: "庭師(第2回目配信楽曲）",
        title: "煙",
        ...
        comment:
          "庭師です。今回も採用頂きありがとうございます。\nロックとジャズのガチ両刀です。\n宜しくお願い致します。\n(庭師)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：BerryVerrine\nSOUND VOLTEXの公募には何度か応募していたのですが、ついについに、ジャケットイラストが採用される日が来てしまいました！\n毎度テイストを変えるブレブレな私ですが、今回は和風っぽい、御伽噺っぽいイメージを目指しました。\n「月まで届け、不死の煙」は大好きな曲の一つなので、イラストを手掛けることができ、とても嬉しいです！\n今回はお誘いいただきありがとうございました。改めまして、採用いただきありがとうございます！\n(BerryVerrine)",
      },
      {
        artist: "polysha(第2回目配信楽曲）",
        ...
        comment:
          "こんにちは、polysha(ポリシャ)といいます。\n徹夜は目に良くないのでちゃんと寝ましょう。\n(polysha)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：wakamana\nはじめましてwakamanaと申します～。\n今回polyshaさんの楽曲のジャケットを描かせていただきました。\n一緒に採用されるとは思ってもいなかったのでめちゃくちゃ嬉しいです！\nみすちーのかわいさと曲名にあるような怪しさがジャケットから伝わったらいいなと思います！\n是非遊んでください～！\n(wakamana)",
      },
      {
        artist: "うさぎ愛好会(cosMo×syuri22)(第2回目配信楽曲）",
        ...
        comment:
          "永夜抄コンテストおめでとうございます！\n「誰が為に兎は舞う=狂速狂騒曲=」の作詞・歌唱を担当しました、うさぎ愛好会のsyuri22です。\n念願の東方リミックスデビューなのでちょっぴり感慨に耽っております。\n長年抱き続けているうどんげへの妄想をこのたび放出して制作に取り組みました。\n楽しく聴いて遊んで、キレッキレでウサッウサな狂気の瞳を感じていただけたら幸いです。\n(syuri22)\n今回は東方アレンジということで、東方大好きなsyuri22さん主導のもと、僕は編曲面でお手伝いさせていただきました。よろしくお願いいたします。\n(cosMo＠暴走P)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：syuri22\n「誰が為に兎は舞う=狂速狂騒曲=」のジャケットイラストを制作しました、syuri22です。\n楽曲とともに採用賜ることができ光栄です。\n楽曲にこめた一連のイメージをイラストとしても出力してみました。ぐるぐる～ウラハラ～トラ～ウマ～な感じです。\n楽曲と合わせて、キレッキレでウサッウサな狂気の瞳を感じていただけたら幸いです。\n(syuri22)",
      },
      {
        artist: "テヅカ feat. 大西あみみ(第1回目配信楽曲）",
        title: "私の恋色。",
        ...
        comment:
          "テヅカと申します！\n「僕らの時間」に続いての採用、ありがとうございます。\n「私の恋色。」という曲です。\n「※論理について。」という東方アレンジサークルをしているくらい\n東方が好きなので、その東方のコンテストで採用されて嬉しいです。\nお題が「東方永夜抄」という事で、これまた大好きな霧雨魔理沙ちゃんの「恋色マスタースパーク」をアレンジさせて頂きました！\n歌詞にも力を入れているので良かったら聴いてみてください。\n霧雨魔理沙と霧雨魔理沙に救われる少女の話です。\n皆の中にも情景が浮かんできてくれると嬉しいなと思います。\n是非プレイしてみて下さいね！\n(テヅカ)\nこの度はご採用いただきありがとうございます！\n水槽のクジラ、僕らの時間に引き続き嬉しいです！\n今回はギターのodasisさんもお迎えしてさらにパワーアップしてます！\nしいばさんのとーってもかわいいイラストやテヅカさんのピコピコ可愛くどこか切なく感じる楽曲に合うように優しく、心を込めて歌わせて頂きました！\nイラストも楽曲も歌も楽しみにしててくださると嬉しいです！\nどうぞよろしくお願いします。\n(ボーカル：大西あみみ)\n自分が関わった作品が採用され感無量です！\n素晴らしいアレンジでかっこよく仕上がっておりますのでぜひプレイしてください！\n(Lchギター：odasis)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：△○□×\nこの度は採用有難う御座います！\nテヅカさんが強い（個人的見解）ピコピコロックアレンジで、他にも推しポイント色々あるので沢山遊んで聴いて頂ければ。\nそしてあみみさんが可愛い！！\nイラストについては東方キャラクターはフリルとかが多くてフワッフワさせられるので毎回強風吹かせてしまいます。\n宜しくお願いします。\n(△○□×)",
      },
      {
        ...
        comment:
          "紡ぎ続ける幻想曲。\n鳴り止まぬ鎮魂歌。\n全てが0と1に還る刻まで。\n(シイナフユキ)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：みどりねこ feat. RF\n初めまして、ジャケットイラストを担当させて頂きました\nサークル『みどりねこ』代表、みどりです。\nダークで神秘的なシイナフユキさんの素敵な楽曲に合わせ\nスタイリッシュな綺麗さを目指しました。\n少しでも楽曲の魅力を引き立てる事が出来ていたらいいなと思います。\n青春から今もなお人生に根強く影響を与えてくれた東方Projectと\n絵を描きはじめるキッカケの一つとなった音楽ゲーム、\nそれらのお仕事に一度は携わってみたいという目標が達成できました。\nこの場に参加できる機会を下さった方々には本当に感謝しております。\nぜひ楽しんで頂ければ幸いです。\n(みどり)\nデザイナーのRFです。ほぼ何もしてないような気がします。\nみどりさんとシイナを引き合わせたのが一番大きな仕事だったと思います。\n名義については難しくて、みどりさんの名義の後にくっつけるなら「みどりねこ a.k.a. RF」にしておけば、みどりさんの功績も掻っ攫えるとおもったのですが、バレました\n(RF)",
      },
      {
        ...
        comment:
          "ボルテプレイヤーの皆さま初めまして。AMAZEと申します。\nこの度は採用をいただき大変嬉しく思います。\nこのリミックスはボルテの大きな特徴である直角アナログデバイスを強く意識した曲です。\nもっと言うと、曲の中で何度も登場するピアノのトリル→1拍空き→ジャーン！で直角が入れば気持ちいいな！\nと思って制作した曲です。\nというわけで実際のエフェクトについても「ジャーン！」の部分が直角になってほしいと思うと共に、\n本当にそうなったとしたら皆さまにも「ジャーン！」の気持ちよさを体感してほしいと思います。\nよろしくお願いいたします。\n(AMAZE)\n※こちらの作品はジャケットも一緒に採用されました\nイラストレーター名：未早\nこんにちは、昆虫大好き、未早でございます。\n今回はAMAZEさんのオシャレ楽曲のジャケットを描かせていただきました！\n夜が止まった森の奥、蟲達の淡き光を集めて、想いよ届け、月光(あなた)まで。\nゆったりと壮大な音色を奏でる月夜にふんわり輝く蛍の群れと戯れるリグルをイメージして描きました。\nいっぱい遊んでみてくださいね！\n(未早)",
      },
    ],
  },
  {
